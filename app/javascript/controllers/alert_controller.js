...
export default class extends Controller {
  ...
  run(e) {
    ...
    this.buttonsTarget.innerHTML =
      '<span class="text-sm leading-5 font-medium text-grey-700">Processing...</span>';
    ...
    fetch(this.data.get("action-url"), {
      ...
      if (response.status === 200) {
        content =
          '<span class="text-sm leading-5 font-medium text-green-700">Done!</span>';
      } else {
        content =
          '<span class="text-sm leading-5 font-medium text-red-700">Error!</span>';
      }
