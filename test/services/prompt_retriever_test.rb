...
class PromptRetrieverTest < ActiveSupport::TestCase
  test "should retrieve prompt by label and organization ID" do
    prompt_data = PromptRetriever.retrieve("prompt-one-label", "8c5e36bb-6163-4d07-8a7e-9f13e77d6e40")
  ...
  test "should fallback to retrieve prompt without organization ID" do
    prompt_data = PromptRetriever.retrieve("prompt-two-label")
    assert_not_nil prompt_data
  ...
  test "should return nil when prompt is not found" do
    prompt_data = PromptRetriever.retrieve("non-existent-label", "8c5e36bb-6163-4d07-8a7e-9f13e77d6e40")
