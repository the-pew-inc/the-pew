...
ActiveRecord::Schema[7.0].define(version: 20_220_607_232_424) do
  ...
  create_table 'questions', force: :cascade do |t|
    ...
    t.index(%w[user_id room_id], name: 'index_questions_on_user_id_and_room_id')
    t.index(%w[user_id status], name: 'index_questions_on_user_id_and_status')
